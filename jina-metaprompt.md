...
<body>
    <header>
        <h1>Jina AI Meta-Prompt: An Implementation Guide for LLMs  (v7)</h1>
        <div class="notice" style="background: #f5f5f5; padding: 20px; margin: 20px 0; border-radius: 8px;">
            ...
            <p>This particular version: </p> <code style="background: #eee; padding: 10px; margin: 10px;">curl docs.jina.ai/v7</code>
